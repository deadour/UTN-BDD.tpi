...
try:
    # Consulta para obtener los codpost de laboratorios
...
# --> para generar transportistaA (desde el archivo inserciones)
# from mysql.connector import Error
# import mysql.connector
# from faker import Faker
# import random
...
#         codT_list = random.sample(range(1, 31), 30)
#         # operaciones con cada codpost
#         num_viaje = random.randint(1, 7)  # Genera un número aleatorio entre 1 y 7, de los transportes que llegan a esa ciudad
#         for n in range(num_viaje):
#             codT= codT_list.pop()
#             data.append((codT, codpost))
